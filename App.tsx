              ...
              <div className="bg-gray-800 rounded-lg aspect-square w-full flex items-center justify-center border-2 border-gray-700">
               ...
               {generatedImageUrl && !isLoading && (
                <button
                  ...
                  className="mt-4 w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition-colors duration-200 flex items-center justify-center gap-2"
                >
